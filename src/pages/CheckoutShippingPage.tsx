        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <form onSubmit={handleSubmit} className="lg:col-span-2 space-y-6">
                ...
                <div className="grid sm:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option>Spain</option> <option>Italy</option>{' '}
                      <option>Netherlands</option> <option>Austria</option>
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <div
                        className={`w-3 h-3 rounded-full ${shippingMethod === 'standard' && 'bg-salmon'}`}
                      />
                    </div>
                    <div>
                  ...
                  <span
                    className={
                      subtotal > 50 ? 'text-green-600' : 'text-brown-dark'
                    }
                  >
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <div
                        className={`w-3 h-3 rounded-full ${shippingMethod === 'express' && 'bg-salmon'}`}
                      />
                    </div>
                    <div>
                      <p className="text-brown-dark font-medium">
            ...
            <div className="flex gap-4">
              ...
              <button
                type="submit"
                className="flex-1 bg-sand hover:bg-salmon text-white py-4 px-6 rounded-xl font-bold transition-all duration-300 shadow-lg shadow-sand/40"
              >
                Continue to Payment
              </button>
            </div>
