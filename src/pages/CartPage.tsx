        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {items.map(({ product, quantity }) => (
              <div
                key={product.id}
                className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-4 md:p-6 flex gap-4 border border-gray-700"
              >
                {/* Изображение */}
                ...
                <div className="flex-grow flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mt-1 line-clamp-2 hidden md:block">
                      {product.description}
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    <div className="flex items-center bg-gray-700 rounded-lg">
                      <button
                        ...
                        className="px-3 py-1 text-white hover:bg-gray-600 rounded-l-lg transition"
                      >
                        −
                      </button>
                      ...
                      <button
                        onClick={() => updateQuantity(product.id, quantity + 1)}
                        className="px-3 py-1 text-white hover:bg-gray-600 rounded-r-lg transition"
                      >
                        +
                      </button>
                    </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700 sticky top-24">
              ...
              <div className="mb-6">
                <div className="flex gap-2">
                  ...
                  />
                  <button className="bg-gray-600 hover:bg-gray-500 text-white px-4 py-3 rounded-xl transition-colors">
                    Apply
                  </button>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full bg-pink-500 hover:bg-pink-600 text-white py-4 px-6 rounded-xl font-bold text-lg transition-all duration-300 shadow-lg shadow-pink-500/30"
              >
                Proceed to Checkout
              </button>
